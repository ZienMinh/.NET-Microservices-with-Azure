...
public interface IProductsRepository
{
    ...
    /// <summary>
    /// Retrievies all products based 
    /// on the specified codition asynchronously.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves a single product based on 
    /// the specified condition asynchronously.
    /// </summary>
    ...
    /// <returns>Returns the updated product; or if not found</returns>
